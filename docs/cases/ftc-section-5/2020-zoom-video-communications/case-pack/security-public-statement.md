# Security Public Statement (Zoom Video Communications, Inc.)

> Public-facing security statement aligned with order restrictions.
...
**Scenario:** (2021) (Security/legal lead) (executive, regulator, customer, or assessor audience) (Communications team drafts public statement with Legal and Security.)

<div class="writing-example-formal">
<p><strong>Subject: </strong>Security Public Statement for Zoom FTC order response</p>
...
<p><strong>Decision or ask: </strong>Approve a cross-functional remediation track focused on communicating improvements without overstating security. The work should be jointly owned by Security, Product Engineering, Legal, Privacy, Communications, and GRC so public claims, product behavior, and evidence records remain aligned.</p>
<p><strong>Implementation: </strong>Use factual, verifiable language and avoid absolute claims about encryption or privacy controls unless reviewed by Security and Legal. The first phase inventories public and in-product security claims; the second phase validates cryptographic design, key custody, update behavior, and cloud-recording storage; the third phase creates release gates and evidence packages for independent assessment.</p>
...
<p><strong>Expected output: </strong>A public statement draft that is accurate, specific, and consistent with FTC restrictions. Success means Zoom can demonstrate that security statements are reviewed before publication, software updates do not weaken third-party security protections, and order-required controls are supported by durable evidence rather than one-time attestations.</p>
</div>
