# Security Program Status Report (Zoom Video Communications, Inc.)

> Program status against FTC order obligations.
...
**Scenario:** (2021) (Security/legal lead) (executive, regulator, customer, or assessor audience) (Program owner reports progress to CISO and General Counsel.)

<div class="writing-example-formal">
<p><strong>Subject: </strong>Security Program Status Report for Zoom FTC order response</p>
...
<p><strong>Decision or ask: </strong>Approve a cross-functional remediation track focused on status reporting for comprehensive security program implementation. The work should be jointly owned by Security, Product Engineering, Legal, Privacy, Communications, and GRC so public claims, product behavior, and evidence records remain aligned.</p>
<p><strong>Implementation: </strong>Maintain a program dashboard for annual risk assessment, vulnerability management, MFA controls, data deletion controls, credential controls, update review, and assessor evidence. The first phase inventories public and in-product security claims; the second phase validates cryptographic design, key custody, update behavior, and cloud-recording storage; the third phase creates release gates and evidence packages for independent assessment.</p>
...
<p><strong>Expected output: </strong>A status report showing progress, blocked items, control maturity, and upcoming assessment needs. Success means Zoom can demonstrate that security statements are reviewed before publication, software updates do not weaken third-party security protections, and order-required controls are supported by durable evidence rather than one-time attestations.</p>
</div>
