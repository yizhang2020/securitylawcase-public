# Board Pack (Zoom Video Communications, Inc.)

> Board briefing on FTC order response and trust remediation.
...
**Scenario:** (2021) (Security/legal lead) (executive, regulator, customer, or assessor audience) (CISO briefs the Board Audit Committee after the proposed FTC settlement.)

<div class="writing-example-formal">
<p><strong>Subject: </strong>Board Pack for Zoom FTC order response</p>
...
<p><strong>Decision or ask: </strong>Approve a cross-functional remediation track focused on board oversight of FTC order remediation, encryption-claims governance, and release-risk reduction. The work should be jointly owned by Security, Product Engineering, Legal, Privacy, Communications, and GRC so public claims, product behavior, and evidence records remain aligned.</p>
<p><strong>Implementation: </strong>Create board-level milestones for comprehensive security program governance, independent assessment readiness, and escalation of claim or release exceptions. The first phase inventories public and in-product security claims; the second phase validates cryptographic design, key custody, update behavior, and cloud-recording storage; the third phase creates release gates and evidence packages for independent assessment.</p>
...
<p><strong>Expected output: </strong>A board packet with risk posture, remediation milestones, owner accountability, and unresolved decision points. Success means Zoom can demonstrate that security statements are reviewed before publication, software updates do not weaken third-party security protections, and order-required controls are supported by durable evidence rather than one-time attestations.</p>
</div>
