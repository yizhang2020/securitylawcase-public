# Security Governance Memo (Zoom Video Communications, Inc.)

> Governance model for product security, legal review, and order compliance.
...
**Scenario:** (2021) (Security/legal lead) (executive, regulator, customer, or assessor audience) (CISO issues governance memo to product, engineering, legal, and marketing.)

<div class="writing-example-formal">
<p><strong>Subject: </strong>Security Governance Memo for Zoom FTC order response</p>
...
<p><strong>Decision or ask: </strong>Approve a cross-functional remediation track focused on defining governance for product, security, legal, and communications teams. The work should be jointly owned by Security, Product Engineering, Legal, Privacy, Communications, and GRC so public claims, product behavior, and evidence records remain aligned.</p>
<p><strong>Implementation: </strong>Establish a cross-functional Security Claims and Release Review Council with recurring review, issue tracking, and executive escalation. The first phase inventories public and in-product security claims; the second phase validates cryptographic design, key custody, update behavior, and cloud-recording storage; the third phase creates release gates and evidence packages for independent assessment.</p>
...
<p><strong>Expected output: </strong>A governance memo that makes responsibility clear before claims or releases go live. Success means Zoom can demonstrate that security statements are reviewed before publication, software updates do not weaken third-party security protections, and order-required controls are supported by durable evidence rather than one-time attestations.</p>
</div>
