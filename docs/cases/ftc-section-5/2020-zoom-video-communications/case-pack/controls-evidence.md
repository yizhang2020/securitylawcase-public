# Controls Evidence Map (Zoom Video Communications, Inc.)

> Evidence map for order compliance.
...
**Scenario:** (2021) (Security/legal lead) (executive, regulator, customer, or assessor audience) (Control owners prepare evidence package for independent assessment.)

<div class="writing-example-formal">
<p><strong>Subject: </strong>Controls Evidence Map for Zoom FTC order response</p>
...
<p><strong>Decision or ask: </strong>Approve a cross-functional remediation track focused on producing evidence that controls exist and operate. The work should be jointly owned by Security, Product Engineering, Legal, Privacy, Communications, and GRC so public claims, product behavior, and evidence records remain aligned.</p>
<p><strong>Implementation: </strong>Define evidence artifacts for claim review, encryption/key-management testing, vulnerability management, software-update review, MFA deployment, data deletion, and incident reporting. The first phase inventories public and in-product security claims; the second phase validates cryptographic design, key custody, update behavior, and cloud-recording storage; the third phase creates release gates and evidence packages for independent assessment.</p>
...
<p><strong>Expected output: </strong>An evidence map ready for counsel, assessor, or FTC staff. Success means Zoom can demonstrate that security statements are reviewed before publication, software updates do not weaken third-party security protections, and order-required controls are supported by durable evidence rather than one-time attestations.</p>
</div>
